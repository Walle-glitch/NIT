...
lst = (41, 39, 26, 32, 40, 46, 51, 37)
först = lst[0]          # tuple första element
sist = lst[-1]          # tuple sista element
minst = min(lst)       # tuple minsta element
störst = max(lst)       # tuple största element
summa = sum(lst)         # summan av tuple element
antal = len(lst)     # antal element i tuple, tuple längd
print(först, sist, minst, störst, summa, antal)
